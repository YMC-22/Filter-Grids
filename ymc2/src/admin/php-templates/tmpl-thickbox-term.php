    ...
    <div class="thickbox-inner">
        <div class="toolbar">
            <div class="toolbar-inner">
                <div class="info-bar">
                    <p>
					    <?php esc_html_e('These options allow you to customize how terms are displayed and styled across your site: colors, icons, and more.', 'ymc-smart-filters' ); ?>
                    </p>
                </div>
                <div class="actions">
                ...
                <div class="tab-content is-active" id="tabTerm">
                    <div class="tab tab-term-inner">
                        <div class="form-item">
                            ...
                            <span class="description"><?php esc_attr_e('Set term background.', 'ymc-smart-filters' ); ?></span>
                        ...
                        <div class="form-item">
                            ...
                            <span class="description"><?php esc_attr_e('Set term color.', 'ymc-smart-filters' ); ?></span>
                        ...
                        <div class="form-item">
                            ...
                            <span class="description"><?php esc_attr_e('Set term class.', 'ymc-smart-filters' ); ?></span>
                            <input class="form-input js-term-class" type="text" name='term_class' />
                        </div>
                        <div class="form-item">
                            <header class="form-label">
                                <span class="heading-text"><?php esc_attr_e('Term Default', 'ymc-smart-filters' ); ?></span>
                            </header>
                            <span class="description"><?php esc_attr_e('Set term default.', 'ymc-smart-filters' ); ?></span>
                        ...
                        <div class="form-item">
                            <header class="form-label">
                                <span class="heading-text"><?php esc_attr_e('Term Visible', 'ymc-smart-filters' ); ?></span>
                            </header>
                            <span class="description"><?php esc_attr_e('Uncheck term visible.', 'ymc-smart-filters' ); ?></span>
                            <div class="group-elements">
                        ...
                        <div class="form-item">
                            ...
                            <span class="description"><?php esc_attr_e('Set term name.', 'ymc-smart-filters' ); ?></span>
                        ...
                        <div class="form-item">
                            ...
                            <div class="multi-buttons">
                                <label class="button-switch">
                                    ...
                                    <span class="fa-solid fa-align-left button-label"></span>
                                </label>
                                <label class="button-switch">
                                    <input class="js-icon-alignment" type="radio" name="icon_alignment" value="right">
                                    <span class="fa-solid fa-align-right button-label"></span>
                                </label>
                            </div>
                        </div>
                        <div class="form-item">
                            ...
                            <div class="icon-selected">
                                ...
                                <input class="js-icon-url" type="hidden" name="icon_url" value="">
                                <input class="js-domain" type="hidden" name="domain" value="<?php echo esc_url(site_url()); ?>">
                                <span class="icon-preview js-icon-preview"></span>
                                <buton class="button button-icon js-btn-icon-remove"><i class="fa-solid fa-trash"></i></buton>
                            </div>
                        </div>
                    </div>
